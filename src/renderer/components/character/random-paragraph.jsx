...
function randomParagraphGenerator(randNum, [maxLength]) {
...
const RANDOM_PARAGRAPH = 'Random Paragraph';

class RandomParagraph extends Component {
  static propTypes = {
...
export { RANDOM_PARAGRAPH, randomParagraphGenerator };
