...
function randomSentenceGenerator(randNum, [maxLength]) {
...
const RANDOM_SENTENCE = 'Random Sentence';
...
export { RANDOM_SENTENCE, randomSentenceGenerator };
